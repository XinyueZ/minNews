...
public interface TblBookmarkedNewsItem {
	...
	String SQL_CREATE = "CREATE TABLE " + TABLE_NAME + " (" + COL_URL + " TEXT PRIMARY KEY, " + COL_TITLE + " TEXT, "
			+ COL_CONTENT + " TEXT, " + COL_PREVIEW + " TEXT, " + COL_IMAGE_URL + " TEXT, " + COL_DATE + " INTEGER, "
			+ COL_IS_HOT + " INTEGER " + ");";
	String STMT_INSERT = "INSERT INTO " + TABLE_NAME + " (" + COL_URL + "," + COL_TITLE + "," + COL_CONTENT + ","
			+ COL_PREVIEW + "," + COL_IMAGE_URL + "," + COL_DATE + "," + COL_IS_HOT + ")" + " VALUES (?,?,?,?,?,?,?)";
